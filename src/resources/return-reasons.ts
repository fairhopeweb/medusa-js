...
class ReturnReasonsResource extends BaseResource {
   ...
   * @return AsyncResult<{ return_reason: ReturnReason }>
   */
  retrieve(
    id: string,
    options: RequestOptions = {}
  ): Types.AsyncResult<{ return_reason: Types.ReturnReason }> {
   ...
   * @return AsyncResult<{ return_reasons: ReturnReason[] }>
   */
  list(
    options: RequestOptions = {}
  ): Types.AsyncResult<{ return_reasons: Types.ReturnReason[] }> {
