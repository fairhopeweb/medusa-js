...
class ProductVariantsResource extends BaseResource {
   ...
   * @return AsyncResult<{ variant: ProductVariant }>
   */
  retrieve(
    id: string,
    options: RequestOptions = {}
  ): Types.AsyncResult<{ variant: Types.ProductVariant }> {
   ...
   * @return AsyncResult<{ variants: ProductVariant[] }>
   */
  list(
    ids?: string[],
    options: RequestOptions = {}
  ): Types.AsyncResult<{ variants: Types.ProductVariant[] }> {
